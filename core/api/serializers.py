...
class CustomTokenObtainSerializer(TokenObtainPairSerializer):
    ...
    def get_token(cls, user):
        ...
        token['permissions'] = {
            ...
            'suppliers': user.can_manage_suppliers,
            'expenses': user.can_manage_expenses,
    ...
    def validate(self, attrs):
        ...
        data['user'] = {
            ...
            'permissions': {
                ...
                'suppliers': self.user.can_manage_suppliers,
                'expenses': self.user.can_manage_expenses,
...
class UserMeSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'can_manage_expenses',
            'can_manage_sales', 'can_manage_inventory',
            'can_view_reports',
